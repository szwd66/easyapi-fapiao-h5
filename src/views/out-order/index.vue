...
<template>
  ...
  >
    <div v-if="state.minusOutOrderList.length > 0" style="margin-bottom: 30px">
      ...
      <div v-for="(item, index) in state.minusOutOrderList" :key="index" class="mint-checklist">
    ...
    <div v-for="(item, index) in state.outOrderList" :key="index" class="mint-checklist">
      <div class="mint-cell-wrapper">
